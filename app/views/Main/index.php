...
<section class="services">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h3 class="section-title"><?php __('main_index_our_advantages') ?></h3>
      </div>

      <div class="col-md-3 col-sm-6">
        <div class="service-item">
          <p class="text-center"><i class="fas fa-shipping-fast"></i></p>
          <p><?php __('main_index_direct_deliveries') ?></p>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="service-item">
          ...
          <p><?php __('main_index_wide_range') ?></p>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="service-item">
          ...
          <p><?php __('main_index_pleasant_prices') ?></p>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="service-item">
          ...
          <p><?php __('main_index_professional_consultation') ?></p>
        </div>
      </div>
