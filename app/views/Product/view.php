  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <ul class="thumbnails list-unstyled clearfix">
        <li class="thumb-main text-center"><a class="thumbnail" href="<?= PATH ?>/assets/img/products/apple_cinema_30.jpg" data-effect="mfp-zoom-in"><img src="<?= PATH ?>/assets/img/products/imac_1.jpg" alt=""></a></li>

        <li class="thumb-additional"><a class="thumbnail" href="<?= PATH ?>/assets/img/products/1.jpg" data-effect="mfp-zoom-in"><img src="<?= PATH ?>/assets/img/products/1.jpg" alt=""></a></li>
        <li class="thumb-additional"><a class="thumbnail" href="<?= PATH ?>/assets/img/products/2.jpg" data-effect="mfp-zoom-in"><img src="<?= PATH ?>/assets/img/products/2.jpg" alt=""></a></li>
        <li class="thumb-additional"><a class="thumbnail" href="<?= PATH ?>/assets/img/products/3.jpg" data-effect="mfp-zoom-in"><img src="<?= PATH ?>/assets/img/products/3.jpg" alt=""></a></li>
        <li class="thumb-additional"><a class="thumbnail" href="<?= PATH ?>/assets/img/products/4.jpg" data-effect="mfp-zoom-in"><img src="<?= PATH ?>/assets/img/products/4.jpg" alt=""></a></li>
      </ul>
